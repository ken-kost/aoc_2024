defmodule Aoc2024.Solutions.Y24.Day22Test do
  ...
  #
  #     mix AoC.test --year 2024 --day 22
  #
  #     mix test test/2024/day22_test.exs
  #
  # To run the solution
  #
  #     mix AoC.run --year 2024 --day 22 --part 1
  #
  # Use sample input file:
  #
  #     # returns {:ok, "priv/input/2024/day-22-mysuffix.inp"}
  #     {:ok, path} = Input.resolve(2024, 22, "mysuffix")
  #
  # Good luck!
