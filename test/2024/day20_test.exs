defmodule Aoc2024.Solutions.Y24.Day20Test do
  ...
  #
  #     mix AoC.test --year 2024 --day 20
  #
  #     mix test test/2024/day20_test.exs
  #
  # To run the solution
  #
  #     mix AoC.run --year 2024 --day 20 --part 1
  #
  # Use sample input file:
  #
  #     # returns {:ok, "priv/input/2024/day-20-mysuffix.inp"}
  #     {:ok, path} = Input.resolve(2024, 20, "mysuffix")
  #
  # Good luck!
