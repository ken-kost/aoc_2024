defmodule Aoc2024.Solutions.Y24.Day21Test do
  ...
  #
  #     mix AoC.test --year 2024 --day 21
  #
  #     mix test test/2024/day21_test.exs
  #
  # To run the solution
  #
  #     mix AoC.run --year 2024 --day 21 --part 1
  #
  # Use sample input file:
  #
  #     # returns {:ok, "priv/input/2024/day-21-mysuffix.inp"}
  #     {:ok, path} = Input.resolve(2024, 21, "mysuffix")
  #
  # Good luck!
  ...
  test "part two example" do
    ...
    assert 154_115_708_116_294 == solve(input, :part_two)
  end
