defmodule Aoc2024.Solutions.Y15.Day02Test do
  alias AoC.Input, warn: false
  alias Aoc2024.Solutions.Y15.Day02, as: Solution, warn: false
  ...
  #
  #     mix test test/2015/day02_test.exs
  #
  # To run the solution
  #
  ...
  #
  #     # returns {:ok, "priv/input/2015/day-02-mysuffix.inp"}
  #     {:ok, path} = Input.resolve(2015, 2, "mysuffix")
  #
  # Good luck!
