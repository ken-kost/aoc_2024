defmodule Aoc2024.Solutions.Y15.Day01Test do
  alias AoC.Input, warn: false
  alias Aoc2024.Solutions.Y15.Day01, as: Solution, warn: false
  ...
  #
  #     mix test test/2015/day01_test.exs
  #
  # To run the solution
  #
  ...
  #
  #     # returns {:ok, "priv/input/2015/day-01-mysuffix.inp"}
  #     {:ok, path} = Input.resolve(2015, 1, "mysuffix")
  #
  # Good luck!
