defmodule Aoc2024.Solutions.Y15.Day07Test do
  alias AoC.Input, warn: false
  alias Aoc2024.Solutions.Y15.Day07, as: Solution, warn: false
  ...
  #
  #     mix test test/2015/day07_test.exs
  #
  # To run the solution
  #
  ...
  #
  #     # returns {:ok, "priv/input/2015/day-07-mysuffix.inp"}
  #     {:ok, path} = Input.resolve(2015, 7, "mysuffix")
  #
  # Good luck!
